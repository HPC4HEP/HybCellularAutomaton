...
*/
int push_backsv(OMPSimpleVector* v, const OMPCACell* element) {
...
\param element The element to insert
*/
int push_back_tssv(OMPSimpleVector* v, const OMPCACell* element) {
	int previousSize;
...
*/
int pop_backsv(OMPSimpleVector* v, const OMPCACell** cell) {
	if(v->m_size > 0) {
		int previousSize = (v->m_size)--;
